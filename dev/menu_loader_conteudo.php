...
if(HM_IsMenu) {
    var1 = "<SCR" + "IPT LANGUAGE='JavaScript1.2' SRC='../inc/menu_options.php' TYPE='text/javascript'><\/SCR" + "IPT>";
	document.write (var1);
	var2 ="<SCR" + "IPT LANGUAGE='JavaScript1.2' SRC='../inc/menu_functions.js' TYPE='text/javascript'><\/SCR" + "IPT>";
	document.write (var2);
}
