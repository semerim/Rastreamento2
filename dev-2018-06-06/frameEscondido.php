...
<form name="frmTopo">
   ...
   <!-- Campos LOV -->
   <input type='hidden' name='countLOV' value="<? echo MAX_ROWS_VIEW ?>">
   ...
   <!-- Campos Visão -->
   <input type='hidden' name='countVIEW' value="<? echo MAX_ROWS_VIEW ?>">
   ...
   <!-- Campos Detalhe -->
   <input type='hidden' name='countDET' value="<? echo MAX_ROWS_VIEW ?>">
