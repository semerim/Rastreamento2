...
HM_GL_MenuWidth          = 150;
HM_GL_FontFamily         = "Arial, Verdana";
HM_GL_FontSize           = 10;
...
function HM_f_MakeMenu(menucount) {
	...
	while (NewMenu.itemCount < NewMenu.maxItems) {
		NewMenu.itemCount++;
// 		if(HM_StatusDisplayBuild) status = "Creating HierarchicalMenus: " + menucount + " / " + NewMenu.itemCount;
//         alert (menucount);
...
//   	NewMenu.style.left = 20;
// 	alert (NewMenu.style.left);
